...
var global = arguments[3];
var e=arguments[3],n=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var n={};if(null!=e)for(var r in e)Object.hasOwnProperty.call(e,r)&&(n[r]=e[r]);return n.default=e,n},r=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var t=n(require("msgpack-lite")),o=require("./adapter"),a=r(require("./logger")),i={iceServers:[{urls:"stun:stun.l.google.com:19302"}],sdpSemantics:"unified-plan"},u=function(){function e(){}var n;return e.noop=function(){},e.validateId=function(e){return!e||/^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(e)},e.pack=function(e){a.default.log("pack ",e);var n=t.encode(e);return a.default.log("BinaryPack.encode ",n),new Blob(n)},e.unpack=function(e){a.default.log("unpack ",e);var n=new Uint8Array(e);return a.default.log("unpack array ",n),t.decode(n)},e.chunk=function(n){for(var r,t=[],o=n.size,a=Math.ceil(o/e.chunkedMTU),i=r=0;i<o;){var u=Math.min(o,i+e.chunkedMTU),c=n.slice(i,u),l={__peerData:this._dataCount,n:r,data:c,total:a};t.push(l),i=u,r++}return this._dataCount++,t},e.blobToArrayBuffer=function(e,n){var r=new FileReader;r.onload=function(e){n(e.target.result)},r.readAsArrayBuffer(e)},e.blobToBinaryString=function(e,n){var r=new FileReader;r.onload=function(e){n(e.target.result)},r.readAsBinaryString(e)},e.binaryStringToArrayBuffer=function(e){for(var n=new Uint8Array(e.length),r=0;r<e.length;r++)n[r]=255&e.charCodeAt(r);return n.buffer},e.randomToken=function(){return Math.random().toString(36).substr(2)},e.isSecure=function(){return"https:"===location.protocol},e.CLOUD_HOST="0.peerjs.com",e.CLOUD_PORT=443,e.chunkedBrowsers={Chrome:1},e.chunkedMTU=16300,e.defaultConfig=i,e.browser=(n=window).mozRTCPeerConnection?"Firefox":n.webkitRTCPeerConnection?"Chrome":n.RTCPeerConnection?"Supported":"Unsupported",e.supports=function(){if(void 0===o.RTCPeerConnection)return{};var e,n,r=!0,t=!0,a=!1,u=!1,c=!!window.webkitRTCPeerConnection;try{e=new o.RTCPeerConnection(i,{optional:[{RtpDataChannels:!0}]})}catch(d){r=!1,t=!1}if(r)try{n=e.createDataChannel("_PEERJSTEST")}catch(d){r=!1}if(r){try{n.binaryType="blob",a=!0}catch(d){}var l=new o.RTCPeerConnection(i,{});try{u=l.createDataChannel("_PEERJSRELIABLETEST",{}).ordered}catch(d){}l.close()}return t&&(t=!!e.addStream),e&&e.close(),{audioVideo:t,data:r,binaryBlob:a,binary:u,reliable:u,sctp:u,onnegotiationneeded:c}}(),e._dataCount=1,e}();exports.util=u;
},{"msgpack-lite":"mwm5","./adapter":"sXtV","./logger":"8WOs"}],"2JJl":[function(require,module,exports) {
...
"use strict";var e=this&&this.__extends||function(){var e=function(t,n){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])})(t,n)};return function(t,n){function i(){this.constructor=t}e(t,n),t.prototype=null===n?Object.create(n):(i.prototype=n.prototype,new i)}}(),t=this&&this.__values||function(e){var t="function"==typeof Symbol&&e[Symbol.iterator],n=0;return t?t.call(e):{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}}},n=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t};Object.defineProperty(exports,"__esModule",{value:!0});var i=require("reliable"),r=require("./util"),o=n(require("./logger")),a=require("./negotiator"),s=require("./enums"),l=require("./baseconnection"),u=function(n){function l(e,t,i){var o=n.call(this,e,t,i)||this;return o._buffer=[],o._bufferSize=0,o._buffering=!1,o._chunkedData={},o.connectionId=o.options.connectionId||l.ID_PREFIX+r.util.randomToken(),o.label=o.options.label||o.connectionId,o.serialization=o.options.serialization||s.SerializationType.Binary,o.reliable=o.options.reliable,o.options._payload&&(o._peerBrowser=o.options._payload.browser),o._negotiator=new a.Negotiator(o),o._negotiator.startConnection(o.options._payload||{originator:!0}),o}return e(l,n),Object.defineProperty(l.prototype,"type",{get:function(){return s.ConnectionType.Data},enumerable:!0,configurable:!0}),Object.defineProperty(l.prototype,"dataChannel",{get:function(){return this._dc},enumerable:!0,configurable:!0}),Object.defineProperty(l.prototype,"bufferSize",{get:function(){return this._bufferSize},enumerable:!0,configurable:!0}),l.prototype.initialize=function(e){this._dc=e,this._configureDataChannel()},l.prototype._configureDataChannel=function(){var e=this;if(r.util.supports.sctp&&(this.dataChannel.binaryType="arraybuffer"),this.dataChannel.onopen=function(){o.default.log("Data channel connection success"),e._open=!0,e.emit(s.ConnectionEventType.Open)},!r.util.supports.sctp&&this.reliable){var t=o.default.logLevel>o.LogLevel.Disabled;this._reliable=new i.Reliable(this.dataChannel,t)}this._reliable?this._reliable.onmessage=function(t){e.emit(s.ConnectionEventType.Data,t)}:this.dataChannel.onmessage=function(t){e._handleDataMessage(t)},this.dataChannel.onclose=function(){o.default.log("DataChannel closed for:",e.peer),e.close()}},l.prototype._handleDataMessage=function(e){var t=this,i=e.data,a=i.constructor;if(o.default.log("_handleDataMessage ",e," data ",i," datatype ",a),this.serialization===s.SerializationType.Binary||this.serialization===s.SerializationType.BinaryUTF8){if(a===Blob)return void r.util.blobToArrayBuffer(i,function(e){o.default.log("datatype === Blob",e),i=r.util.unpack(e),t.emit(s.ConnectionEventType.Data,i)});if(a===ArrayBuffer){var l=new Uint8Array(i);o.default.log("datatype === ArrayBuffer",l),i=r.util.unpack(l)}else if(a===String){var u=r.util.binaryStringToArrayBuffer(i);i=r.util.unpack(u)}}else this.serialization===s.SerializationType.JSON&&(i=JSON.parse(i));if(i.__peerData){var f=i.__peerData,p=this._chunkedData[f]||{data:[],count:0,total:i.total};return p.data[i.n]=i.data,p.count++,p.total===p.count&&(delete this._chunkedData[f],i=new Blob(p.data),this._handleDataMessage({data:i})),void(this._chunkedData[f]=p)}n.prototype.emit.call(this,s.ConnectionEventType.Data,i)},l.prototype.close=function(){this._buffer=[],this._bufferSize=0,this._negotiator&&(this._negotiator.cleanup(),this._negotiator=null),this.provider&&(this.provider._removeConnection(this),this.provider=null),this.open&&(this._open=!1,n.prototype.emit.call(this,s.ConnectionEventType.Close))},l.prototype.send=function(e,t){var i=this;if(this.open)if(this._reliable)this._reliable.send(e);else if(this.serialization===s.SerializationType.JSON)this._bufferedSend(JSON.stringify(e));else if(this.serialization===s.SerializationType.Binary||this.serialization===s.SerializationType.BinaryUTF8){var a=r.util.pack(e),l=r.util.chunkedBrowsers[this._peerBrowser]||r.util.chunkedBrowsers[r.util.browser];if(o.default.log("util.supports.sctp ",r.util.supports.sctp," needsChunking ",l," send blob ",a),l&&!t&&a.size>r.util.chunkedMTU)return void this._sendChunks(a);r.util.supports.sctp?r.util.supports.binaryBlob?this._bufferedSend(a):r.util.blobToArrayBuffer(a,function(e){o.default.log("blobToArrayBuffer array buffer ",e),i._bufferedSend(e)}):r.util.blobToBinaryString(a,function(e){i._bufferedSend(e)})}else this._bufferedSend(e);else n.prototype.emit.call(this,s.ConnectionEventType.Error,new Error("Connection is not open. You should listen for the `open` event before sending messages."))},l.prototype._bufferedSend=function(e){o.default.log("_bufferedSend ",e),!this._buffering&&this._trySend(e)||(this._buffer.push(e),this._bufferSize=this._buffer.length)},l.prototype._trySend=function(e){var t=this;if(o.default.log("_trySend ",e),!this.open)return!1;try{this.dataChannel.send(e)}catch(n){return this._buffering=!0,setTimeout(function(){t._buffering=!1,t._tryBuffer()},100),!1}return!0},l.prototype._tryBuffer=function(){if(this.open&&0!==this._buffer.length){var e=this._buffer[0];this._trySend(e)&&(this._buffer.shift(),this._bufferSize=this._buffer.length,this._tryBuffer())}},l.prototype._sendChunks=function(e){var n,i,o=r.util.chunk(e);try{for(var a=t(o),s=a.next();!s.done;s=a.next()){var l=s.value;this.send(l,!0)}}catch(u){n={error:u}}finally{try{s&&!s.done&&(i=a.return)&&i.call(a)}finally{if(n)throw n.error}}},l.prototype.handleMessage=function(e){var t=e.payload;switch(e.type){case s.ServerMessageType.Answer:this._peerBrowser=t.browser,this._negotiator.handleSDP(e.type,t.sdp);break;case s.ServerMessageType.Candidate:this._negotiator.handleCandidate(t.candidate);break;default:o.default.warn("Unrecognized message type:",e.type,"from peer:",this.peer)}},l.ID_PREFIX="dc_",l}(l.BaseConnection);exports.DataConnection=u;
